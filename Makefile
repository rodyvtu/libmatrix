...
FUNCTIONS := \
	...
	matrix_new_static matrix_new_dynamic matrix_add_block matrix_complete matrix_norm matrix_apply matrix_toarray \
	vector_new vector_fill vector_add_block vector_toarray vector_dot vector_norm vector_complete vector_or vector_copy vector_axpy vector_as_setzero_operator vector_nan_from_supp \
